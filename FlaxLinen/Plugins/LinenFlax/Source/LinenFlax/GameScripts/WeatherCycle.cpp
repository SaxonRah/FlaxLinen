...
void WeatherCycle::OnUpdate()
{
    ...
    if (currentCondition != m_currentWeather || 
        Math::Abs(currentIntensity - m_currentIntensity) > 0.05f ||
        Math::Abs(transitionProgress - m_transitionProgress) > 0.05f) {
